...
#[derive(Clone)]
pub struct ParametricCurvesCollection {
    list: Vec<ParametricCurves>,
}
#[derive(Clone)]
...
impl ParametricCurvesCollection {
...
impl Index<usize> for ParametricCurvesCollection {
    type Output = ParametricCurves;
...
impl IndexMut<usize> for ParametricCurvesCollection {
    fn index_mut(&mut self, index: usize) -> &mut Self::Output {
        &mut self.list[index]
    }
}

impl Default for ParametricCurvesCollection {
    fn default() -> Self {
        ...
        list.push(ParametricCurves {
            curves,
            evaluator: Self::default_eval_parametric_fn,
        });
        Self { list }
    }
}
